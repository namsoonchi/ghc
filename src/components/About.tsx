...
const About = () => {
  ...
  return (
    <section id="about" className="py-20 bg-gradient-to-br from-[#E0E0E0] via-[#F3F3F3] to-[#00796B]/10 relative overflow-hidden">
      {/* Background Shapes */}
      <div className="absolute top-0 right-0 w-64 h-64 bg-gradient-to-bl from-[#7CB342]/25 to-[#33691E]/10 rounded-full -translate-y-32 translate-x-32"></div>
      <div className="absolute bottom-0 left-0 w-96 h-96 bg-gradient-to-tr from-[#00ACC1]/25 to-[#00796B]/15 rounded-full translate-y-48 -translate-x-48"></div>
      <div className="absolute top-1/2 left-1/2 w-32 h-32 bg-gradient-to-br from-[#7CB342]/15 to-[#00ACC1]/10 rounded-full transform -translate-x-1/2 -translate-y-1/2"></div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            <h2 className="text-4xl lg:text-5xl font-bold text-[#1C4E80] mb-6">
              About <span className="text-[#33691E]">CareConnect</span>
            </h2>
            ...
            <button
              ...
              className="bg-[#7CB342] text-white px-8 py-4 rounded-full hover:bg-[#33691E] transition-all duration-300 font-semibold shadow-lg hover:shadow-xl transform hover:-translate-y-1"
            >
              Meet Our Team
            </button>
          </div>
