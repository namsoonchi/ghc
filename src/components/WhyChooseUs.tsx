...
const WhyChooseUs = () => {
  ...
  return (
    <section id="why-choose-us" className="py-20 bg-gradient-to-br from-[#F3F3F3] via-[#E0E0E0] to-[#00ACC1]/10 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <h2 className="text-5xl lg:text-6xl font-bold text-[#1C4E80] mb-6 leading-tight">
            WHY CHOOSE <span className="block text-[#33691E]">CARECONNECT</span>
          </h2>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-[#1C4E80] mb-6 leading-relaxed">
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-[#1C4E80]">Rigorous background checks for all caregivers</span>
              </div>
              <div className="flex items-center space-x-3">
                <CheckCircle className="w-6 h-6 text-[#7CB342] flex-shrink-0" />
                <span className="text-[#1C4E80]">Ongoing training and professional development</span>
              </div>
              <div className="flex items-center space-x-3">
                <CheckCircle className="w-6 h-6 text-[#7CB342] flex-shrink-0" />
                <span className="text-[#1C4E80]">Regular quality assurance and family feedback</span>
              </div>
              <div className="flex items-center space-x-3">
                <CheckCircle className="w-6 h-6 text-[#7CB342] flex-shrink-0" />
                <span className="text-[#1C4E80]">Flexible scheduling to meet your needs</span>
              </div>
            </div>
          </div>

          <div className="bg-gradient-to-br from-[#F3F3F3]/90 via-[#E0E0E0]/90 to-[#00ACC1]/10 rounded-2xl p-8 shadow-2xl border border-[#00ACC1]/30">
            <div className="text-center">
              ...
              <h4 className="text-2xl font-bold text-[#1C4E80] mb-4">Our Promise</h4>
              <p className="text-[#1C4E80] leading-relaxed mb-6">
              ...
              <div className="grid grid-cols-3 gap-4 text-center">
                <div>
                  ...
                  <p className="text-sm text-[#33691E]">Happy Families</p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="text-sm text-[#33691E]">Support</p>
                </div>
              </div>
            </div>
          </div>
