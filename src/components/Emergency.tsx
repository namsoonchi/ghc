...
const Emergency = () => {
  ...
  return (
    <section id="emergency" className="py-20 bg-gradient-to-br from-[#F3F3F3] via-[#E0E0E0] to-[#00ACC1]/10 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <h2 className="text-5xl lg:text-6xl font-bold text-[#1C4E80] mb-6 leading-tight">
            EMERGENCY <span className="block text-[#33691E]">SUPPORT</span>
          </h2>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            <div className="grid md:grid-cols-2 gap-6 mb-8">
              {emergencyFeatures.map((feature, index) => (
                <div 
                  key={index}
                  className="group bg-gradient-to-br from-[#F3F3F3] via-[#E0E0E0] to-[#00ACC1]/10 rounded-2xl p-6 hover:shadow-xl transition-all duration-500 hover:-translate-y-2 border border-[#00ACC1]/30 hover:border-[#7CB342]/50"
                >
                  <div className="inline-flex items-center justify-center w-12 h-12 bg-gradient-to-br from-[#00ACC1] to-[#00796B] rounded-xl mb-4 group-hover:scale-110 transition-transform duration-300">
                    <feature.icon className="w-6 h-6 text-white" />
                  </div>
                  <h3 className="text-lg font-bold text-[#1C4E80] mb-2 group-hover:text-[#33691E] transition-colors duration-300">
                    {feature.title}
                  </h3>
            ...
            <div className="bg-gradient-to-br from-[#F3F3F3]/90 via-[#E0E0E0]/90 to-[#00ACC1]/10 rounded-2xl p-6 border border-[#00ACC1]/30">
              <h3 className="text-xl font-bold text-[#1C4E80] mb-4 flex items-center">
          ...
          <div>
            <div className="bg-gradient-to-br from-[#F3F3F3]/95 via-[#E0E0E0]/90 to-[#00ACC1]/10 rounded-2xl p-8 border border-[#00ACC1]/40 shadow-2xl">
              <div className="text-center mb-8">
                ...
                <h3 className="text-2xl font-bold text-[#1C4E80] mb-2">Emergency Hotline</h3>
                <p className="text-[#33691E]">Available 24 hours a day, 7 days a week</p>
              </div>

              <div className="text-center mb-8">
                <a 
                  href="tel:555-911-CARE" 
                  className="text-4xl font-bold text-[#1C4E80] hover:text-[#33691E] transition-colors duration-300 block mb-2"
                >
                  (555) 911-CARE
                </a>
                <p className="text-[#33691E] text-sm">Call immediately for any emergency situation</p>
              </div>

              <div className="space-y-4">
                <div className="flex items-center justify-between p-4 bg-gradient-to-r from-[#E0E0E0] to-[#F3F3F3] rounded-lg border border-[#00ACC1]/20">
                  <span className="text-[#1C4E80]">Average Response Time</span>
                  <span className="text-[#7CB342] font-bold">{"< 15 minutes"}</span>
                </div>
                <div className="flex items-center justify-between p-4 bg-gradient-to-r from-[#E0E0E0] to-[#F3F3F3] rounded-lg border border-[#00ACC1]/20">
                  <span className="text-[#1C4E80]">Coverage</span>
                  <span className="text-[#7CB342] font-bold">24/7/365</span>
                </div>
                <div className="flex items-center justify-between p-4 bg-gradient-to-r from-[#E0E0E0] to-[#F3F3F3] rounded-lg border border-[#00ACC1]/20">
                  <span className="text-[#1C4E80]">Certified Staff</span>
                  <span className="text-[#7CB342] font-bold">100%</span>
                </div>
              </div>

              <div className="mt-8 p-4 bg-gradient-to-r from-[#00ACC1]/20 to-[#00796B]/10 rounded-lg border border-[#00ACC1]/30">
                <p className="text-[#1C4E80] text-sm text-center">
